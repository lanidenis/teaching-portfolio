...
include ('connect.php');
$rs = mysqli_query($mysql, $sql) or die("Cannot Execute Delete query"); 
...
<LINK REL=StyleSheet HREF="flyout_h2.css" style type="text/css"> 
</style>
</head>
<body>
<h3> Delete / Edit </h3>
...
echo '<form style="background-color: #fdedf2; position: static; display:block; width: 50%; margin: 0 auto;" id="bibliography" action="process_edit2.php" method="post" enctype="multipart/form-data" >'; }
else if($table == 'tools') { echo '<form style="background-color: #fdedf2; position: static; display:block; width: 40%; margin: 0 auto;" id="bibliography" action="process_edit2.php" method="post" enctype="multipart/form-data" >';}
else { echo '<form style="background-color: #fdedf2; position: static; display:block; width: 100%; margin: 0 auto;" id="bibliography" action="process_edit2.php" method="post" enctype="multipart/form-data" >';}

 print $frm; 
 echo '<p><input type="hidden" name="record" value="'.$_SESSION['record'].'"</p>';
 echo '<br><p style="display: block; width: 200px; margin: 0 auto;"><input style="width: 200px; height: 80px; margin-top: 20px; margin-bottom: 60px; font-size: 40px;" name="save" type="submit" value="Save"></p>';
 ?>
 </form>
<?php
}
...
header("Location: create_feedback_mob.php?hid=".$_POST['record']);
} 
...
$rs=mysqli_query( $mysql, $sql) or die("Cannot execute Select Bibliography query");
   $list = "<b><p style=\"color: navy; text-align: center; font-size: 56pt;\">Publications</p><b>";
  $list .= "<table style=\"display: block; width: 100%; margin: 0 auto; font-size: 48px;\" border=\"1\" cellpadding=\"5\">";
...
#$list.= "<tr><td>ID</td><td>".$row[0]."</td></tr>"; 	
	#     $list.= "<td>".$authors."</td>";
$list.= "<tr><td>Title</td><td><textarea rows=\"3\" cols=\"25\" name=\"title\" >".$row[1]."</textarea></td></tr>";
$list.= "<tr><td>Book Title</td><td><textarea rows=\"3\" cols=\"25\" name=\"booktitle\" >".$row[2]."</textarea></td></tr>";
$list.= "<tr><td>Periodical</td><td><textarea rows=\"2\" name=\"periodical\" >".$row[3]."</textarea></td></tr>";
$list.= "<tr><td>Publisher</td><td><textarea  rows=\"3\" cols=\"25\" name=\"publisher\" >".$row[4]."</textarea></td></tr>";
$list.= "<tr><td>Publ. Place</td><td><textarea rows=\"3\" cols=\"25\" name=\"place\" >".$row[5]."</textarea></td></tr>";
$list.= "<tr><td>Editor</td><td><textarea  rows=\"3\" cols=\"25\" name=\"editor\" >".$row[6]."</textarea></td></tr>";
$list.= "<tr><td>Year</td><td><input type =\"text\"  value=\"$row[7]\" size=\"4\" name=\"year\" /></td></tr>";
$list.= "<tr><td>Month</td><td><input type =\"text\"  value=\"$row[8]\" size=\"13\" name=\"month\" /></td></tr>";
$list.= "<tr><td>Day</td><td><input type =\"text\"  value=\"$row[9]\" size=\"3\" name=\"day\" /></td></tr>";
...
$list.= "<tr><td>Status</td><td><input type =\"text\"  value=\"$row[14]\" size=\"13\" name=\"status\" /></td></tr>";
$list.= "<tr><td>Bibliography Type</td><td><input type =\"text\"  value=\"$row[15]\" size=\"13\" name=\"type\" /></td></tr>";
...
$rs=mysqli_query( $mysql, $sql) or die("Cannot execute select from presentations query");
   $list = "<b><p style=\"color: navy; text-align: center; font-size: 56pt;\">Presentation</p><b>";
  $list .= "<table style=\"display: block; width: 100%; margin: 0 auto; font-size: 48px;\" border=\"1\" cellpadding=\"5\">";
...
$list.= "<tr><td>Presentor</td><td><textarea  rows=\"2\" cols=\"25\" name=\"presentor\" > ".$row[2]." </textarea></td></tr>";
$list.= "<tr><td>Title</td><td><textarea  rows=\"3\" cols=\"25\" name=\"title\">".$row[3]."</textarea></td></tr>";	
$list.= "<tr><td>Method</td><td><textarea rows=\"2\" cols=\"25\" name=\"method\" >".$row[4]." </textarea></td></tr>";	
$list.= "<tr><td>Session(hr)</td><td><input type =\"text\"  value=\"$row[5]\" size=\"3\" name=\"session\" /></td></tr>";
$list.= "<tr><td>Authors</td><td><textarea rows=\"2\" cols=\"25\" name=\"authors\" > ".$row[6]." </textarea></td></tr>";	
$list.= "<tr><td>Audience</td><td><textarea rows=\"2\" cols=\"25\" name=\"audience\"> ".$row[7]." </textarea></td></tr>";
...
$list.= "<tr><td>New Feedback Form?</td><td><input type=\"radio\" name=\"feedback\" value=\"Create New Form\"></td></tr>";
}
#$list.= "<tr><td>Feedback</td><td><textarea rows=\"3\" cols=\"50\" name=\"feedback\">".$row[8]." </textarea></td></tr>";

$list.= "<tr><td>Meeting</td><td><textarea rows=\"3\" cols=\"25\"  name=\"meeting\"> ".$row[9]."</textarea></td>";
...
$list.= "<tr><td>Month</td><td><input type =\"text\"  value=\"$row[13]\" size=\"13\" name=\"month\" /></td></tr>";
$list.= "<tr><td>Upload a PDF</td><td><input style=\"font-size: 20px;\" size=\"20\" name=\"newfile\" type=\"file\"/></td></tr>";
...
if($tbl == 'cme') { 
	...
	$list = "<h5>CME</h5>";
	$list .= "<table style=\"display: block; width: 47%; margin: 0 auto;\" border=\"1\" cellpadding=\"1\">";  
while($row = mysqli_fetch_row( $rs) )  {    
$list.= "<tr><td><input type =\"text\"  value=\"$row[0]\" size=\"2\" name=\"id\" readonly = \"readonly\"  /></td></tr>";

$list.= "<tr><td>Date</td><td><input type =\"text\"  value=\" $row[1] \" size=\"10\" name=\"date\" /></td></tr>";
$list.= "<tr><td>Title</td><td><textarea rows=\"3\" name=\"title\" >".$row[2]."</textarea></td></tr>";
$list.= "<tr><td>Type</td><td><input type=\"text\" value=\"$row[3]\" size=\"10\" name=\"type\"  /></td></tr>";
$list.= "<tr><td>Credit</td><td><input type=\"text\" value=\"$row[4]\" size=\"5\" name=\"credit\"  /></td></tr>";               
 }
 $list .= "</table>";
 }
 if($tbl == 'moca') { 
	...
	$rs=mysqli_query( $mysql, $sql) or die("Cannot execute query");
	$list = "<h5>MOCA</h5>";
	$list .= "<table style=\"display: block; width: 50%; margin: 0 auto;\" border=\"1\" cellpadding=\"1\">";  
while($row = mysqli_fetch_row( $rs) )  {    
$list.= "<tr><td><input type =\"text\"  value=\"$row[0]\" size=\"2\" name=\"id\" readonly = \"readonly\"  /></td></tr>";
$list.= "<tr><td>Date</td><td><input type =\"text\"  value=\" $row[5] \" size=\"10\" name=\"date\" /></td></tr>";
$list.= "<tr><td>Title</td><td><textarea rows=\"3\" name=\"title\" >".$row[4]."</textarea></td></tr>";
$list.= "<tr><td>Activity</td><td><textarea rows=\"3\" name=\"activity\" >".$row[3]."</textarea></td></tr>";
$list.= "<tr><td>Status</td><td><textarea rows=\"3\" name=\"status\" >".$row[2]."</textarea></td></tr>";
$list.= "<tr><td>Credit</td><td><input type=\"text\" value=\"$row[6]\" size=\"5\" name=\"credit\"  /></td></tr>";               
 }
 $list .= "</table>";
 }
if($tbl == 'prof') {
...
$list.= "<tr><td><input type =\"text\"  value=\"$row[0]\" size=\"2\" name=\"id\" readonly=\"readonly\" /></td></tr>"; 
 #       $list.= "<tr><td>ID</td><td>".$row[0]."</td> </tr>"; 	
	$list.= "<tr><td>Professional Appointment</td><td><textarea rows=\"3\" name=\"appointment\" >".$row[1]."</textarea></td></tr>";	
...
if($tbl == 'awards') { 
	...
	$list = "<h5>Awards</h5>";
  $list .= "<table style=\"display: block; width: 94%; margin: 0 auto;\" border=\"1\" cellpadding=\"2\">";
...
$rs=mysqli_query( $mysql, $sql) or die("Cannot execute query");
 ...
 $list .= "<table style=\"display: block; width: 93%; margin: 0 auto;\" border=\"1\" cellpadding=\"1\">";
    $list .= "<tr>";
...
$rs=mysqli_query( $mysql, $sql) or die("Cannot execute query");
    $list = "<h5>TOOLS</h5>";
 $list .= "<table style=\"display: block; width: 95%; margin: 0 auto;\" border=\"1\" cellpadding=\"1\">";
 $list .= "<tr>";
